...
plot '/root/results/node-memory-utilization.csv.s.t' using 2:xtic(1) title 'clusters-3' with linespoints ls 1\
, '/root/results/node-memory-utilization.csv.s.t' using 3 title 'clusters-5' with linespoints ls 2\
, '/root/results/node-memory-utilization.csv.s.t' using 4 title 'clusters-10' with linespoints ls 3
