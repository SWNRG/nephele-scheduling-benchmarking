...
plot '/root/results/cluster-node-utilization.csv.s.t' using 2:xtic(1) title 'light-cpu' with linespoints ls 1\
, '/root/results/cluster-node-utilization.csv.s.t' using 3 title 'medium-cpu' with linespoints ls 2\
, '/root/results/cluster-node-utilization.csv.s.t' using 4 title 'large-cpu' with linespoints ls 3\
, '/root/results/cluster-node-utilization.csv.s.t' using 5 title 'mixture-cpu' with linespoints ls 4
