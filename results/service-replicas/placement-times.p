...
plot 'placement-times.csv.s' using 2:xtic(1) title 'cluster placement time' with linespoints ls 1\
, 'placement-times.csv.s' using 3 title 'node placement time' with linespoints ls 2
