...
plot '/root/results/node-cpu-utilization.csv.s.t' using 2:xtic(1) title 'replica-1' with linespoints ls 1\
, '/root/results/node-cpu-utilization.csv.s.t' using 3 title 'replicas-5' with linespoints ls 2\
, '/root/results/node-cpu-utilization.csv.s.t' using 4 title 'replicas-10' with linespoints ls 3\
, '/root/results/node-cpu-utilization.csv.s.t' using 5 title 'replicas-20' with linespoints ls 4\
, '/root/results/node-cpu-utilization.csv.s.t' using 6 title 'replicas-30' with linespoints ls 5
