...
plot '/root/results/placement-times.csv.s' using 2:xtic(1) title 'light-memory' with linespoints ls 1\
, '/root/results/placement-times.csv.s' using 3 title 'medium-memory' with linespoints ls 2\
, '/root/results/placement-times.csv.s' using 4 title 'large-memory' with linespoints ls 3\
, '/root/results/placement-times.csv.s' using 5 title 'mixture-memory' with linespoints ls 4
